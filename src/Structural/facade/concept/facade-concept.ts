...
class SubSystemClassC {
  // A hypothetically complicated class
  method(value: SubSysCSign): SubSysCSign {
    return value;
  }
}

class Facade {
  // A simplified facade offering the services of the subsystems
  ...
  subSystemClassC(value: SubSysCSign): SubSysCSign {
    // Uses the subsystems method
